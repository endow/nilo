...
GROUPS = {
    ...
    "status": [
        ...
        "test_queue_*",
        "test_compact_ai_status_uses_english_roadmap_labels",
    ],
    ...
    "project": ["test_project_*", "test_primary_language_falls_back_to_os_locale_without_project_files"],
    ...
    "task": [
        ...
        "test_base_commit_*",
        "test_outcome_*",
        "test_japanese_project_task_creation_*",
        "test_high_risk_completion_message_uses_project_primary_language",
    ],
