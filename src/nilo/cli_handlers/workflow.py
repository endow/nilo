    ...
    print(
        "\n".join(
            [
                ...
                "- If project / git_root / db_path differ, do not use that MCP server; use CLI fallback.",
                "- On mismatch, do not ask the human. Run `nilo status --ai` and then `nilo next` from the target repository cwd.",
                ...
                "- Large work must be routed through roadmap first.",
                "",
                "Use roadmap first when the work:",
                "- touches multiple modules or files,",
                "- changes DB schema or migrations,",
                "- adds or changes CLI commands,",
                "- changes status / next / AI-facing output,",
                "- requires README/docs/tests together,",
                "- has multiple completion criteria,",
                "- affects compatibility or safety-sensitive flows.",
                "",
                "Roadmap flow:",
                "- `nilo roadmap discuss`",
                "- human accepts with `nilo roadmap accept`",
