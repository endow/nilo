...
def register_roadmap(sub: argparse._SubParsersAction, handlers: ModuleType) -> None:
    ...
    roadmap_adopt.add_argument("--actor", choices=["human", "ai"], default="human")
    ...
    roadmap_accept.add_argument("--actor", choices=["human", "ai"], default="human")
    ...
    roadmap_reject.add_argument("--actor", choices=["human", "ai"], default="human")
    ...
    roadmap_close.add_argument("--actor", choices=["human", "ai"], default="human")
